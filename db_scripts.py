...
def clear_db():
    """ Очистить используемые таблицы БД """
    connect_db()
...
def get_question_after(last_id=0, vict_id=1):
    """ Возвращает вопрос следующий за вопросом с id передаваемым в качестве параметра функции
...
def get_quises():
    """ Возвращает список викторин типа (id, name)
