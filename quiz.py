...
def quiz_form():
    """ Функция получает список викторин из БД и формирует форму с выпадающим списком """
    q_list = get_quises()
    return render_template('start.html', q_list=q_list)


def index():
    """ Первая страница: если пришли с запросом GET, то выбрать викторину,
...
def question_form(question):
    """
    Получает строку из БД, соответствующую вопросу, возвращает html с формой
